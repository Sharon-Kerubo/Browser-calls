        ...
        <div class="page-wrapper auth">
            <div class="page-inner bg-brand-gradient">
                <div class="page-content-wrapper bg-transparent m-0">
                    ...
                    <div class="flex-1" style="background: url(backend/img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        ...
                                        @csrf
                                            <div class="form-group row">
                                                <!-- <label class="col-xl-12 form-label" for="fname">First Name</label> -->
                                                <div class="col-6 pr-1">
                                                    <input type="text" id="fname" class="form-control" placeholder="First Name" name="first_name" required>
                                                    <div class="invalid-feedback">No, you missed this one.</div>
                                                </div>
                                                <!-- <label class="col-xl-12 form-label" for="lname">Last Name</label> -->
                                                <div class="col-6 pl-1">
                                                    <input type="text" id="lname" class="form-control" placeholder="Last Name" name="last_name" required>
                                                    <div class="invalid-feedback">No, you missed this one.</div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="phone_number">Phone Number will be needed for verification and account recovery</label>
