        ...
        <header class="ip-header" >
            <div class="ip-loader">
                <div class="text-center">
                    <div class="ip-logo"><img  src="{{'website/img/logo_tribo_new.png'}}" height="50" width="294" alt="logo"></div>
                </div>
...
{{--                        </ul>--}}
                    ...
                    <div class="top-header__links col-sm-8">
                        <a href="tel:+522 234 56789"><i class="icon-header icon-call-in color_primary"></i> +522 234 56789</a>
                        <a class="border-right" href="mailto:Support@HealthCare.org"><i class="icon-header icon-envelope-open color_primary"></i> Support@HealthCare.org</a>
                    </div>
                </div>
            </div>
        </div>
